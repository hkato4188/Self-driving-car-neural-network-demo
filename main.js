...
const traffic = [
  ...
  new Car(road.getLaneCenter(2), -3500, 20, 50, "DUMMY", 2, "yellow"),
  ...
  new Car(road.getLaneCenter(2), -5200, 20, 50, "DUMMY", 2, "yellow"),
  new Car(road.getLaneCenter(1), -5800, 20, 50, "DUMMY", 2, "gray"),
  new Car(road.getLaneCenter(2), -6000, 20, 50, "DUMMY", 2, "orange"),
